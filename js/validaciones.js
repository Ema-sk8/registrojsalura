...
const mensajesDeError = {
    ...
    password:{
        ...
        patternMismatch: "Al menos 6 caracteres, maximo 12, debeontener una letra minuscula, una letra mayuscula y no puede contener ccaracteres especiales"
    },
    nacimiento:{
    ...
    numero:{
        ...
        patternMismatch:"El formato requerido es xxx-xxx-xx-xx"
    },
    direccion:{
        valueMissing:"Este campo no puede estar vacio",
...
inputNacimiento.addEventListener("blur",(evento) =>{
    validarNaciemiento(evento.target);
...
function validarNacimiento(input){
    ...
    if(!mayorDeEdad(fechaCliente)){
        mensaje = "Debes tener al menos 18 aos de edad";
    }
